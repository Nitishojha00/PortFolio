...
const Achievement = () => {
  ...
  <ResumeCard
    ...
    result="Success"
    des="Secured an All India Rank of 80437 in JEE Mains, reflecting consistent preparation, strong analytical ability, and proficiency in physics, chemistry, and mathematics. This achievement showcases dedication, focus, and a solid foundation in core engineering concepts."
  />
  <ResumeCard
    title="94.33 Percentile in Naukri Campus Young Turks"
    subTitle="Excelling in Analytical Skills"
    result="Success"
    des="Secured 94.33 percentile in the Naukri Campus Young Turks analytical test, demonstrating strong problem-solving, logical reasoning, and quick decision-making skills. Achieved this without any prior preparation, reflecting natural aptitude and analytical ability."
  />
  <ResumeCard
    title="LeetCode 1719+"
    subTitle="40+ Contests | 600+ Problems Solved"
    result="Success"
    des="Actively participated in over 40 competitive coding contests on LeetCode, consistently challenging myself with diverse algorithmic and data structure problems. Solved around 600 problems ranging from easy to advanced difficulty, achieving a maximum rating of 11719. This rigorous practice has significantly enhanced my problem-solving, optimization, and analytical skills."
  />
  <ResumeCard
    title="CodeChef 1540+"
    subTitle="10+ Contests | 200+ Problems Solved"
    result="Success"
    des="Actively participated in over 10 competitive coding contests on CodeChef, tackling a wide range of algorithmic and data structure challenges. Solved more than 200 problems, ranging from easy to advanced difficulty, which strengthened my problem-solving, optimization, and analytical skills."
  />
</div>
